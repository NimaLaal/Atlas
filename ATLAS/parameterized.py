...
class RedNoise:
    ...
    * ``orf_params``     are the varied ORF parameters (absent when the ORF is
    ...
    def __init__(
        self,
        # ---- GWB ----
        gwb_psd_func, #TODO: THIS IS WHY YOU CAN'T REPARAMETERIZE WITH SINGLE PULSAR
        orf_func,
        ...
        if has_irn:
            ...
            self.f_intrin = f_intrin if f_intrin.ndim == 1 else jnp.broadcast_to(f_intrin, (self.Npulsars, self.int_bins)) 
        ...
        if has_dm:
            ...
            self.f_dm = f_dm if f_dm.ndim == 1 else jnp.broadcast_to(f_dm, (self.Npulsars, self.dm_bins))
        ...
        #self.I = jnp.broadcast_to(a, (crn_bins, len(a))) TODO: Look into this!
