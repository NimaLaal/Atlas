...
# `model_maker` now lives in ATLAS/model.py -- it is the top of the model, not a
# sampler, and its old name here collided with SuperSignal.model_maker. Re-export
# so existing scripts and notebooks keep working.
from ATLAS.model import model_maker  # noqa: E402,F401
